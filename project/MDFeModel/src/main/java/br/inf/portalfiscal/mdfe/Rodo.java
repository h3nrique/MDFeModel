 ...
 *         &lt;element name="CIOT" maxOccurs="unbounded" minOccurs="0">
 *           &lt;simpleType>
...
public class Rodo {
     ...
     * This is why there is not a <CODE>set</CODE> method for the ciot property.
     * 
     * <p>
     ...
     * 
     */
    public List<String> getCIOT() {
        if (ciot == null) {
            ciot = new ArrayList<String>();
        }
        return this.ciot;
    }
